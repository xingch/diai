...
function CreateCheckCode()
 {
  global $met_webkeys;
  $string   = rand(1, 9).rand(1, 9).rand(1, 9).rand(1, 9999).rand(1, 9).rand(1, 99).rand(1, 9).rand(1, 9).rand(1, 999).rand(1, 9).rand(1, 9);
  $this->mCheckCode = str_replace(array('0','O'),'A',strtoupper(substr($string,0,$this->mCheckCodeNum)));
